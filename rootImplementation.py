...
def TingTarTid(pathData,x_rad,y_rad,hitMatrix,h_cell,ProtDrawM,LET,NumIon,DoseCell):
    ...
    for i,x in enumerate(unique):  # opens each unique proton so every proton does not have to be opend twice
